...
ax1.plot(xListLong, yListLong, zListLong, label='Long Evaluation Result')
ax1.plot(xListShort, yListShort, zListShort, label='Short Evaluation Result')
ax1.scatter(xListLong[0], yListLong[0], zListLong[0], label='Long Evaluation Start', color='b')
ax1.scatter(xListShort[0], yListShort[0], zListShort[0], label='Short Evaluation Start', color='r')
ax1.scatter(xListShort[-1], yListShort[-1], zListShort[-1], label='Goal', color='g')
fig = plt.figure()
ax2 = fig.add_subplot()
ax2.plot(angErrorListLong, label='Long Evaluation Angular Error')
ax2.plot(angErrorListShort, label='Short Evaluation Angular Error')
fig = plt.figure()
ax3 = fig.add_subplot()
ax3.plot(linErrorListLong, label='Long Evaluation Linear Error')
ax3.plot(linErrorListShort, label='Short Evaluation Linear Error')

# Set labels
ax1.set_xlabel('X Position (m)')
ax1.set_ylabel('Y Position (m)')
ax1.set_zlabel('Z Position (m)')
ax1.set_title('Newton Raphson Solution Iterations for EE in 3D Space')
plt.legend()
ax2.set_xlabel('Iteration Number')
ax2.set_ylabel('Angular Error (rad)')
ax2.set_title('Angular Error After Each Iteration of Newton-Raphson')
plt.legend()
ax3.set_xlabel('Iteration Number')
ax3.set_ylabel('Linear Error (m)')
ax3.set_title('Linear Error After Each Iteration of Newton-Raphson')
plt.legend()
